...
async function loadFavicons(container?: HTMLElement): Promise<void> {
    ...
    const faviconImages = targetContainer.querySelectorAll('.bookmark-favicon') as NodeListOf<HTMLImageElement>;
    const faviconPlaceholders = targetContainer.querySelectorAll('.favicon-placeholder') as NodeListOf<HTMLElement>;
