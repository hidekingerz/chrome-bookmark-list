...
describe('3層構造フォルダの問題を検証', () => {
  ...
  it('3層構造のHTMLレンダリングが正しいことを確認', () => {
    ...
    // Level1フォルダの確認
    const level1Element = container.querySelector(
    ...
    // Level2フォルダの確認
    const level2Element = container.querySelector(
      '[data-folder-id="level2-1"]'
    ) as HTMLElement;
    ...
    const level2Container = level2Element.querySelector(
      '.subfolders-container'
    ) as HTMLElement;
  ...
  it('1層目フォルダクリックで2層目以降が消える問題を検証', () => {
    ...
    const level1Header = container.querySelector(
      '[data-folder-id="level1-1"] .folder-header'
    ) as HTMLElement;
  ...
  it('2層目フォルダクリックで3層目が折りたたまれるが2層目は折りたたまれない問題を検証', () => {
    ...
    // 2層目フォルダヘッダーをクリック
    const level2Header = container.querySelector(
      '[data-folder-id="level2-1"] .folder-header'
    ) as HTMLElement;
